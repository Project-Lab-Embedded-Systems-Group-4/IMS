...
typedef union {
    struct {
        ...
        uint8_t output_voltage_range : 2; /* D10-D9: 00=2.0V, 01=200mV, 10=400mV, 11=1.0V */
...
int ad5933_get_complex_data(const struct ims_device *dev, int16_t *real, int16_t *imag, bool unsafe);
